...
const PRODUCTS: ProductType[] = [
  ...
  {
    id: "website",
    ico: <ExternalLink className="w-5 h-5" />,
    name: "Website Generator",
    code: "5-page structure",
    spec: "A comprehensive wireframe and copy generator for Homepage, About, Services, Testimonials, and Contact."
  }
];
      ...
      <main className="flex-1 w-full max-w-[1200px] mx-auto px-6 py-16 sm:py-24">
        ...
        {!archiveView && (
          <>
            ...
            <motion.section 
              className="max-w-5xl mx-auto mb-16 border border-white/5 bg-[#111] p-6 relative overflow-hidden"
            ...
            >
              <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
                <div className="flex-1">
                  <span className="text-[9px] uppercase tracking-widest text-[#E0E0E0] mb-2 block flex items-center gap-2">
                  ...
                  <AnimatePresence mode="popLayout">
                    {discoveries.map((nicheItem) => (
                      <motion.button
                        ...
                        className="px-4 py-2 bg-white/5 border border-white/10 hover:bg-white/10 text-white text-xs whitespace-nowrap transition-colors"
                      >
                        {nicheItem}
                      </motion.button>
                    ))}
                  ...
                  <div className="flex items-center gap-6">
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className={`w-10 h-5 rounded-full p-1 transition-colors ${generateAllProducts ? 'bg-white/90' : 'bg-[#111111] border border-white/20'}`}
                      >
                        <div className={`w-3 h-3 rounded-full bg-[#0A0A0A] transition-transform ${generateAllProducts ? 'translate-x-5' : 'translate-x-0 bg-white/50'}`} />
                      </button>
                    </div>
                    <div className="flex items-center gap-3">
                ...
                <form onSubmit={handleSubmit} className="space-y-12">
                    ...
                    <div className="relative">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            type="button"
                            className="text-[9px] uppercase tracking-widest text-[#E0E0E0] hover:text-white transition-colors flex items-center gap-1 bg-white/5 px-2 py-1"
                            onClick={() => {
                  ...
                  <div className="pt-10 flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-white/5">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full sm:w-auto px-10 py-5 border border-white/20 hover:bg-white hover:text-black transition-all duration-300 text-[10px] uppercase tracking-[0.3em] font-medium disabled:opacity-50 disabled:cursor-wait flex items-center justify-center gap-4 bg-[#0A0A0A]/50"
                    >
                      {loading ? (
                        <>
          ...
          <section className="mb-20 max-w-5xl mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-4">
                ...
                <div className="relative">
                  ...
                  {archiveSearchQuery && (
                    <button 
                      ...
                      className="absolute right-0 top-1/2 -translate-y-1/2 text-white/40 hover:text-white pb-1"
                    >
                      ×
                    </button>
                  )}
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center border border-white/10 rounded overflow-hidden mr-4">
                  <button 
                ...
                {archivedItems.length > 0 && (
                  ...
                  >
                    ...
                    <FileText className={`w-3.5 h-3.5 ${copiedSection === 'copy_archive_json' ? 'hidden' : 'text-white/40'}`} />
                  ...
                  <button
                    ...
                    className={`text-[9px] uppercase tracking-widest transition-colors flex items-center gap-2 border px-4 py-2 ${showArchiveSettings ? 'text-white border-white/40 bg-white/10' : 'text-white/40 border-white/10 hover:text-white hover:bg-white/5'}`}
                  >
                    Settings
                  </button>
                </div>
            ...
            <AnimatePresence>
              {showArchiveSettings && (
                ...
                >
                  <div className="border border-white/10 bg-[#111] p-6 text-sm font-light">
                    <h3 className="text-white/90 mb-6 flex items-center gap-2 text-[10px] uppercase tracking-widest font-medium border-b border-white/10 pb-3"><Info className="w-4 h-4"/> Output Formatting Settings</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div>
                        <label className="block text-[9px] uppercase tracking-[0.3em] text-white/40 mb-3 transition-colors focus-within:text-white/70">
                          Brand Logo URL
                        </label>
                        <input
                          type="text"
                          className="w-full bg-transparent border border-white/10 px-4 py-3 text-sm text-white/90 placeholder:text-white/20 focus:outline-none focus:border-white/50 transition-colors"
                    ...
                    <h3 className="text-white/90 mt-10 mb-6 flex items-center gap-2 text-[10px] uppercase tracking-widest font-medium border-b border-white/10 pb-3"><Info className="w-4 h-4"/> Data Management</h3>
                    <div className="flex flex-wrap gap-4">
                      <button 
                        onClick={handleBackupArchive}
                        className="text-[9px] uppercase tracking-widest text-[#E0E0E0] hover:text-white transition-colors border border-white/10 px-6 py-3 hover:bg-white/5 flex items-center gap-2"
                      >
                        <Download className="w-3.5 h-3.5" /> Backup All Data (JSON)
                      </button>
                      <button 
                        onClick={() => fileInputRef.current?.click()}
                        className="text-[9px] uppercase tracking-widest text-white/50 hover:text-white transition-colors border border-white/10 px-6 py-3 hover:bg-white/5 flex items-center gap-2"
                      >
                        Import Backup
                      </button>
                      <input 
            ...
            >
              ...
              >
                ...
                <div className="absolute top-6 right-6 flex items-center gap-4 print:hidden">
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`w-8 h-4 rounded-full p-0.5 transition-colors ${isPrinterFriendly ? (isPrinterFriendly ? 'bg-black/90' : 'bg-white/90') : 'bg-[#111] border border-white/20'}`}
                    >
                ...
                <div id="print-section" className={isPrinterFriendly ? "mt-8" : ""}>
                  <div className={`flex items-center gap-4 mb-8 ${isPrinterFriendly ? 'border-b border-black/10 pb-6' : 'border-b border-white/10 pb-6'}`}>
                     <div className={`w-12 h-12 flex items-center justify-center border ${isPrinterFriendly ? 'border-black/10 bg-white text-black' : 'border-white/10 bg-[#111] text-white/80'}`}>
                       <Sparkles className="w-5 h-5" />
                     </div>
                     <div>
                       <span className={`text-[9px] uppercase tracking-[0.4em] mb-2 flex items-center gap-3 ${isPrinterFriendly ? 'text-black/40' : 'text-white/40'}`}>
                         Preview Sequence
             ...
             return (
               <>
                 {archiveView && archiveGrouping === 'clusters' && (
                   <div className="max-w-5xl mx-auto mb-16 border border-white/10 bg-[#0A0A0A] p-6">
                       ...
                       {Object.entries(grouped).map(([cluster, items]) => {
                         ...
                         return (
                           <div key={cluster} className="flex flex-col items-center gap-2">
                             ...
                             <span className="text-[9px] uppercase tracking-wider text-white/40 max-w-[80px] text-center leading-tight">{cluster}</span>
                           </div>
                         );
                       })}
                     </div>
                 ...
                 {Object.entries(grouped).map(([cluster, clusterItems]) => (
                   <div key={cluster} className="mb-20">
                     {cluster !== 'All' && (
                       <h3 className="text-xl font-serif italic text-white/80 mb-10 border-b border-white/10 pb-4 max-w-5xl mx-auto">{cluster} <span className="text-white/30 text-sm ml-2">({clusterItems.length})</span></h3>
                     )}
                     <div className={viewMode === 'compact' ? "grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[1400px] mx-auto" : "flex flex-col gap-16"}>
                       ...
                       className={`space-y-12 mb-32 ${viewMode === 'compact' ? 'max-w-none pt-0 border-t-0 space-y-8 bg-[#0a0a0a] border border-white/10 p-6' : `max-w-5xl mx-auto ${index > 0 && cluster === 'All' ? "pt-20 border-t border-white/10" : "mt-20"}`}`}
                     >
                  ...
                  <div>
                    ...
                    {editTitleIndex === index ? (
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        />
                        <button onClick={() => handleSaveTitle(index)} className="text-[9px] uppercase tracking-widest text-[#E0E0E0] hover:text-white transition-colors bg-white/10 px-2 py-1">Save</button>
                        <button onClick={() => setEditTitleIndex(null)} className="text-[9px] uppercase tracking-widest text-white/40 hover:text-white transition-colors">Cancel</button>
                      </div>
                    ) : (
                      <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col relative">
                            <div className="flex items-center gap-2">
                              ...
                              {res.versions && res.versions.length > 0 && (
                                <button onClick={() => setShowVersionsIndex(showVersionsIndex === index ? null : index)} className={`text-[9px] uppercase tracking-widest border px-2 py-0.5 rounded transition-colors ${showVersionsIndex === index ? 'bg-white text-black border-white' : 'text-white/40 hover:text-white border-white/10 hover:border-white/30'}`}>
                                  {res.versions.length} Edit{res.versions.length > 1 ? 's' : ''}
                                </button>
                              )}
                            </div>
                            {showVersionsIndex === index && res.versions && (
                              <div className="absolute top-8 left-0 min-w-80 bg-[#111] border border-white/10 shadow-2xl z-50 p-4 flex flex-col gap-3">
                                <span className="text-[9px] uppercase tracking-[0.3em] text-white/40 border-b border-white/5 pb-2">Version History</span>
              ...
              <div className="border border-white/10 bg-[#0A0A0A] flex flex-col lg:flex-row">
                ...
                <div className="flex-1 border-b lg:border-b-0 lg:border-r border-white/10 flex flex-col">
                  ...
                  <div className="px-8 flex pt-6 pb-4 items-center justify-between border-b border-white/10">
                    <span className="text-[9px] uppercase tracking-[0.3em] text-white/40">Raw Sequence</span>
                    <div className="flex items-center gap-4">
                      <button
                        onClick={() => handlePushToNotion(res, index)}
                        className="text-[9px] uppercase tracking-widest text-white/40 hover:text-white transition-colors flex items-center gap-2 cursor-pointer"
                  ...
                  <div className="p-8 bg-[#111111] flex-1">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className={`w-8 h-4 rounded-full p-0.5 transition-colors ${useMarkdown ? 'bg-white/90' : 'bg-[#111111] border border-white/20'}`}
                            >
                                <div className={`w-2 h-2 rounded-full bg-[#0A0A0A] transition-transform ${useMarkdown ? 'translate-x-4' : 'translate-x-0 bg-white/50'}`} />
                            </button>
                        ...
                        <button
                          ...
                          className="text-[9px] uppercase tracking-widest text-white/50 hover:text-white transition-colors flex items-center gap-2 border border-white/10 px-3 py-1.5"
                        >
                    ...
                    <div className="max-h-[600px] overflow-y-auto bg-[#0A0A0A] border border-white/5 p-8 text-sm font-light text-white/60 leading-relaxed scrollbar-thin selection:bg-white/10 selection:text-white">
                    ...
                    <div className="mt-8 border border-white/5 bg-[#111111] p-6">
                      <span className="text-[9px] uppercase tracking-[0.3em] text-white/40 mb-4 block flex items-center gap-2"><Sparkles className="w-3 h-3"/> Bundle Recommendations</span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {getAssetRecommendations(res.productTitle, res.originalNiche || '', selectedProduct.name).map((rec, rIdx) => (
                          <div key={rIdx} className="bg-[#0A0A0A] border border-white/10 p-5 transition-colors hover:border-white/20 hover:bg-white/5 cursor-pointer flex flex-col justify-between group">
                            ...
                            <div>
                               ...
                               <p className="text-[8px] uppercase tracking-widest text-white/40 font-mono truncate">{rec.code}</p>
                            </div>
                          </div>
                        ))}
                      </div>
                ...
                <div className="w-full lg:w-[420px] p-8 flex flex-col gap-10 bg-[#111111]">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <button
                        ...
                        className="text-[9px] uppercase tracking-widest text-[#E0E0E0] hover:text-white transition-colors disabled:opacity-50"
                      >
                        {isGeneratingCover[index] ? "Generating..." : "Generate Cover Art"}
                      </button>
                    </div>
                    {res.coverImage ? (
                      <div className="border border-white/10 bg-[#0A0A0A] aspect-video w-full flex items-center justify-center overflow-hidden">
                  ...
                  <div className="pt-6 border-t border-white/10">
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <button 
                        ...
                        className="w-10 h-10 flex items-center justify-center border border-white/10 hover:bg-white/10 hover:border-white/30 transition-all text-white/50 hover:text-white" 
                  ...
                  {res.growthTactics && (
                    <div className="pt-6 border-t border-white/10">
                      <div className="flex justify-between items-center mb-4">
                        <span className="text-[9px] uppercase tracking-widest text-[#E0E0E0] block flex items-center gap-2"><Rocket className="w-3 h-3" /> Growth Tactics (3-Month Roadmap)</span>
                        <button
                      ...
                      <div className="text-xs leading-relaxed font-light text-white/60 bg-[#1A1A1A] border border-white/5 p-5 whitespace-pre-wrap">
                        {res.growthTactics}
                      </div>
                    </div>
                  )}
                        ...
                        <AnimatePresence>
                          {qrCodeData[index] && (
                            <motion.div
                              ...
                              className="overflow-hidden"
                            >
                              <div className="bg-white p-6 flex flex-col items-center justify-center mt-2 border border-white/10 relative">
                                <QRCodeSVG 
